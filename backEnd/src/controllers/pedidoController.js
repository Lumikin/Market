...
const pedidoController = {
  ...
  listarItens: async (req, res) => {
    try {
      const result = await pedidoRepositories.listarItens();
  ...
  alterarItem: async (req, res) => {
    try {
      ...
      const { pedidoId, idProduto, quantidade, valorItem } = req.body;
      ...
      const result = await pedidoRepositories.alterarItem(
        itemId,
        pedidoId,
        item,
      );
  ...
  criarItem: async (req, res) => {
    try {
      ...
      const result = await pedidoRepositories.criarItem(pedidoId, item);
  ...
  deletarItem: async (req, res) => {
    try {
      ...
      const result = await pedidoRepositories.deletarItem(itemId);
